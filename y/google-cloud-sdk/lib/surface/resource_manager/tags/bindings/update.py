...
class Update(base.Command):
  ...
  def Run(self, args):
    ...
    for tag_key, tag_value in tags_map_to_update.items():
      ...
      tag_bindings.additionalProperties.append(
          additional_property)
    ...
    update_req = messages.CloudresourcemanagerTagBindingCollectionPatchRequest(
        name=tag_binding_collection_name,
    ...
    with endpoints.CrmEndpointOverrides(location):
      service = tags.UpdateTagBindingCollectionService()
